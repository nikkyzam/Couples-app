...
export const DESIRES: DesireItem[] = [
  ...
  { id: 'x8', label: 'Using a blindfold', level: 3, category: 'touch' },
  { id: 'x9', label: 'Trying a bullet or small vibrator', level: 3, category: 'toys' },
  { id: 'x10', label: 'Light dirty talk', level: 3, category: 'touch' },
  { id: 'x11', label: 'Introducing a couples vibrator', level: 4, category: 'toys' },
  { id: 'x12', label: 'Introducing a dildo', level: 4, category: 'toys' },
  ...
  { id: 'x16', label: 'Using a wand massager together', level: 5, category: 'toys' },
  ...
  { id: 'x25', label: 'A full-body massage with oil', level: 2, category: 'touch' },

  // Level 3 · Warm
  { id: 'x26', label: 'Lots of teasing before anything more', level: 3, category: 'touch' },
  { id: 'x27', label: 'Being blindfolded and surprised', level: 3, category: 'touch' },
  { id: 'x28', label: 'Whispered dirty talk in the moment', level: 3, category: 'touch' },
  { id: 'x29', label: 'Using a warming or tingling lube', level: 3, category: 'toys' },
  { id: 'x30', label: 'Watching each other undress slowly', level: 3, category: 'flirt' },

  // Level 4 · Spicy
  { id: 'x31', label: 'A remote or app-controlled vibrator', level: 4, category: 'toys' },
  { id: 'x32', label: 'A vibrating ring we both feel', level: 4, category: 'toys' },
